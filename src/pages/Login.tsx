            ...
            <CardContent>
              <form onSubmit={e => {
                ...
                <div className="space-y-2">
                  ...
                  <Input id="verificationCode" type="text" value={twoFactorCode} onChange={e => setTwoFactorCode(e.target.value)} required maxLength={6} autoComplete="off" className="text-center text-xl tracking-widest" placeholder="123456" />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input id="password" type={showPassword ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} required disabled={isLoading || isLocked} placeholder="********" className="bg-white pr-10" />
                  <button type="button" className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700" onClick={() => setShowPassword(!showPassword)} aria-label={showPassword ? "Hide password" : "Show password"}>
