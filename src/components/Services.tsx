  ...
  const serviceLines = [
    {
      ...
      services: [
        { name: "Personal Branding for CEOs & Entrepreneurs", icon: <UserRound size={20} /> },
        { name: "Corporate & Business Branding", icon: <Palette size={20} /> },
        { name: "Luxury Brand Strategy & Identity", icon: <Crown size={20} /> },
        { name: "Brand Positioning & Messaging", icon: <Target size={20} /> },
        { name: "Logo, Color Palette & Visual Identity", icon: <Palette size={20} /> },
        { name: "Brand Guidelines & Tone of Voice", icon: <BookOpen size={20} /> },
      ],
    },
    {
      ...
      services: [
        { name: "Social Media Management & Growth", icon: <ChartBar size={20} /> },
        { name: "Paid Ads (Google, FB, IG, LinkedIn)", icon: <Target size={20} /> },
        { name: "SEO & Organic Growth", icon: <ChartBar size={20} /> },
        { name: "Email & Funnel Marketing", icon: <Target size={20} /> },
        { name: "High-Impact Marketing Strategy", icon: <Rocket size={20} /> },
      ],
    },
    {
      ...
      services: [
        { name: "Premium Website Design & Development", icon: <Layout size={20} /> },
        { name: "E-commerce & Landing Page Funnels", icon: <Code size={20} /> },
        { name: "Conversion-Optimized UX/UI Design", icon: <Monitor size={20} /> },
        { name: "Custom Personal Branding Websites", icon: <UserRound size={20} /> },
        { name: "Website Maintenance & Optimization", icon: <Code size={20} /> },
      ],
    },
    {
      ...
      services: [
        { name: "Brand Storytelling & Copywriting", icon: <PenTool size={20} /> },
        { name: "Video Content & Motion Graphics", icon: <Video size={20} /> },
        { name: "Social Media Creatives & Graphics", icon: <Layout size={20} /> },
        { name: "Podcast & Thought Leadership Content", icon: <BookOpen size={20} /> },
        { name: "Reels, Shorts & Viral Video Editing", icon: <Video size={20} /> },
      ],
    },
  ];
      ...
      <div className="container mx-auto">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          {serviceLines.map((line, index) => (
            <div
              key={index}
              className="p-6 md:p-8 rounded-2xl glass hover:shadow-lg transition-all duration-300 fade-up"
            >
