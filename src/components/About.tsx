      ...
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="mt-8 text-3xl md:text-4xl font-bold text-secondary fade-up">
            We Are Your <span className="text-gradient">Creative Partners</span>
          </h2>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            <div
              key={index}
              className={`p-6 md:p-8 rounded-2xl glass hover:shadow-lg transition-all duration-500 hover:transform hover:translate-y-[-5px] fade-up ${feature.delay}`}
            >
